      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse " id="myNavbar">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="#"><i class="fa fa-sign-out" aria-hidden="true" style="color: #fff;"></i> Sign Up </a></li>
            <li><a href="#"><i class="fa fa-sign-out" aria-hidden="true" style="color: #fff;"></i></span> Login </a></li>
          </ul>
        </div>
