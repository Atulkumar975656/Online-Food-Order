...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            <li><a href="#"><i class="fa fa-user-circle-o" aria-hidden="true" style="color: #fff;"></i></span> Welcome <?php echo $_SESSION['login_user2']; ?> </a></li>
...
<ul class="nav navbar-nav navbar-right">
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-sign-in" aria-hidden="true" style="color: #fff;"></i>Sign Up <span class="caret"></span> </a>
