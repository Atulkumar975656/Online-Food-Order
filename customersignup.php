<html>
<head>
    <title> Guest Signup | At Food' </title>
  </head>
...
<link rel="stylesheet" type="text/css" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
  <body>
    ...
    <div class="container">
    <div class="jumbotron">
     <h1>Hi Guest, <br> Welcome to <span class="edit"> At Food' </span></h1>
     <br>
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              ...
              <span class="input-group-btn">
                <label class="btn btn-primary"><i class="fa fa-envelope" aria-hidden="true" style="color: #fff;"></i></label>
            </span>
              </span>
            </div>           
          </div>
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              ...
              <span class="input-group-btn">
                <label class="btn btn-primary"><i class="fa fa-home" aria-hidden="true" style="color:"></i></label>
            </span>
              </span>
            </div>           
          </div>
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              ...
              <span class="input-group-btn">
                <label class="btn btn-primary"><i class="fa fa-lock" aria-hidden="true" style="color: #fff;"></i></label>
            </span>
